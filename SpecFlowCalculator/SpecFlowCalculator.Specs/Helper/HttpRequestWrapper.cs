...
namespace SpecFlowCalculator.Specs.Helper
{
  public  class HttpRequestWrapper
    {
        ...
        public HttpRequestWrapper AddJsonContent(object data)
       {
        ...
        public HttpRequestWrapper AddLoginJsonContent(object data)
        {
            _restRequest.RequestFormat = DataFormat.Json;
            _restRequest.AddHeader("Content-Type", "application/json");
            _restRequest.AddObject(data);
        ...
        public HttpRequestWrapper AddParameterWithoutObject(IDictionary<string, string> parameters)
        {
        ...
        public IRestResponse Execute()
        {
            try
            {
                _restClient = new RestClient("http://localhost:54401/");
