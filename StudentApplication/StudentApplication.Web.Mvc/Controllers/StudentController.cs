...
namespace StudentApplication.Web.Mvc.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult UpdateRecordInfo(int id)
        {
        ...
        public ActionResult DeleteStudent(int id)
        {
            if (_studentRepositoryp.DleteStudent(id)) return RedirectToAction("Index");
            else return RedirectToAction("Index", new { s = "record Does Not Deleted" });
        }
    }
}